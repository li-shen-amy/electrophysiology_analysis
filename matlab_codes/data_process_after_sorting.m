%% data processing after sorting
%
% Read data after soting: 
%   - experiment protocol spreadsheet: e.g. 'sample_data/pcg_exp_record_ana.xlsx'
%   - spike timestamp after sorting: txt file with each row a spike: unit_no, timestamp, ch_no
%                                    e.g.'sample_data/8_20_2019_1_com_tet.txt'
%
% Write processing output:
%   - 'mat' folder: for each unit and each recording session, save the processed data to mat file, 
%                   e.g. 'sample_data/mat/site1rec8_ch1_n5.mat'
%   - 'fig' folder: for each unit and each recording session, export the
%                   figure of raster plot, PSTH, waveform for
%                   visualization, e.g. 'sample_data/mat/site1rec8_ch1_n5.jpg'
%
%%% written by Li Shen; shen938@usc.edu
%%
clc;clear;close all;
